 ...
 * 1） 如果当前节点是左叶节点，则其父节点为下一节点。
 * 2) 如果当前节点为中间节点（上一节点为左叶节点），则寻找其该节点右子树中最小节点作为下一节点，如果其无右子树，则沿路径向上寻找第一个左叶祖先作为下一节点。
 * 3) 如果当前节点为右叶节点（上一节点位中间节点），则沿路径向上寻找第一个左叶祖先，将该祖先的父节点作为下一节点。
